import type { BacknoteConfig, SyncResult } from "../types.js";
import { scanProjectFiles, scanExistingNotes } from "./scanner.js";
import { readNote, writeNote } from "./note-io.js";
import { notePathToProjectPath } from "./backnote-paths.js";
...
const markOrphaned = async (config: BacknoteConfig, notePath: string): Promise<void> => {
...
export const sync = async (config: BacknoteConfig, dryRun = false): Promise<SyncResult> => {
