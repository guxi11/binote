...
4. Only then read the actual source file if the binote note doesn't have enough context

If the binote note is empty or skeleton-only, read the source file directly and mention that `/binote:gen` can populate it.
